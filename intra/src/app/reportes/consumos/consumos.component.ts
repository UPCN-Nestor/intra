...
export class ConsumosComponent implements OnInit {
    ...
    constructor(private http: Http, private el:ElementRef, public router: Router) { 
    ...
    ngOnInit() {
        ...
        this.cols = [
                     {value: 'Cons_area', label: 'Ã�rea' },
                     {value: 'ETTCodigo', label: 'CÃ³digo' },
                     {value: 'Cons_cate', label: 'CategorÃ­a' },
        ...
        this.colsMetadata = { 
                              'Cons_area': { 'orden' : 'alfabetico', 'filtro': this.inArray, 'inputFiltro': 'multiselect', 'boton': 'fa-edit' },    
